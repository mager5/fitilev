        ...
        <div className="max-w-4xl mx-auto bg-[var(--card-bg)] p-6 md:p-8 rounded-lg shadow-lg">
          <section className="mb-8">
            ...
            <ol className="list-decimal pl-6 space-y-2">
              ...
              <li>Настоящая политика Оператора в отношении обработки персональных данных применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта <a href="https://alexfitil.ru" className="text-[var(--accent)] hover:underline">https://alexfitil.ru</a>.</li>
            </ol>
          </section>
          ...
          <section className="mb-8">
            ...
            <ol className="list-decimal pl-6 space-y-2">
              ...
              <li>Веб-сайт – совокупность графических и информационных материалов, а также программ для ЭВМ и баз данных, обеспечивающих их доступность в сети интернет по сетевому адресу <a href="https://alexfitil.ru" className="text-[var(--accent)] hover:underline">https://alexfitil.ru</a>.</li>
              ...
              <li>Персональные данные – любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю веб-сайта <a href="https://alexfitil.ru" className="text-[var(--accent)] hover:underline">https://alexfitil.ru</a>.</li>
              <li>Пользователь – любой посетитель веб-сайта <a href="https://alexfitil.ru" className="text-[var(--accent)] hover:underline">https://alexfitil.ru</a>.</li>
          ...
          <section className="mb-8">
            ...
            <ol className="list-decimal pl-6 space-y-2">
              <li>Оператор обрабатывает персональные данные Пользователя только в случае их заполнения и/или отправки Пользователем самостоятельно через специальные формы, расположенные на сайте <a href="https://alexfitil.ru" className="text-[var(--accent)] hover:underline">https://alexfitil.ru</a>. Заполняя соответствующие формы и/или отправляя свои персональные данные Оператору, Пользователь выражает свое согласие с данной Политикой.</li>
